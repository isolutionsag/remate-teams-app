...
import { IRankingButtonProps } from './IRankingButtonProps';
import styles from './RankingButton.module.scss';


const RankingButton: React.FunctionComponent<IRankingButtonProps> = props => {

  return (
      <div className={styles.rankingCrown} onClick={async () => props.onButtonClicked()}>
